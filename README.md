...
[![Flutter](https://img.shields.io/badge/Flutter-v4.6.1-02569B?logo=flutter)](https://github.com/sceneview/sceneview/tree/main/flutter)
[![React Native](https://img.shields.io/badge/React%20Native-v4.6.1-61DAFB?logo=react)](https://github.com/sceneview/sceneview/tree/main/react-native)
...
<script src="https://cdn.jsdelivr.net/gh/sceneview/sceneview@v4.6.1/website-static/js/filament/filament.js"></script>
<script src="https://cdn.jsdelivr.net/gh/sceneview/sceneview@v4.6.1/website-static/js/sceneview.js"></script>
...
```kotlin
dependencies {
    implementation("io.github.sceneview:sceneview:4.6.1")     // 3D
    implementation("io.github.sceneview:arsceneview:4.6.1")   // AR (includes 3D)
}
```
...
```kotlin
dependencies {
    implementation("io.github.sceneview:sceneview-web:4.6.1")
}
```
