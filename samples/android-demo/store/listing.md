...
## Tags
3D, augmented reality, AR, Jetpack Compose, glTF, 3D viewer, model viewer, ARCore
...
Format: JPEG or PNG, 16:9 or 9:16, min 320px, max 3840px per side

1. **explore_3d.png** — Explore tab showing a 3D model with environment picker chips
2. **ar_placement.png** — AR tab with a model placed on a real surface
3. **samples_grid.png** — Samples grid showing the 14 demo cards
4. **effects_sky.png** — Effects screen with dynamic sky and fog controls
5. **gallery_scroll.png** — Gallery showing multiple live 3D scenes in cards
6. **about_screen.png** — About screen with platform info and links

### 7-inch Tablet (recommended)
Same screenshots adapted for tablet layout.
...
- Already generated: `ic_launcher-playstore.png` in project root
