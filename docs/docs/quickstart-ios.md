...
!!! tip
    ...
    ```swift
    .package(url: "https://github.com/sceneview/sceneview.git", from: "4.10.0")
    ```
...
- **Polish the look** — See the [iOS visual-polish pipeline](recipes/ios-visual-polish.md) for HDR skybox, PBR materials, and Apple AR Quick Look.
