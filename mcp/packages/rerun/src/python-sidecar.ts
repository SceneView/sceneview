...
export interface PythonSidecarOptions {
  ...
  /** If true, default startup mode spawns the viewer. Default: true */
  spawnViewer?: boolean;
  /** Public viewer URL used in "open in browser" hints. Default: SceneView's hosted page. */
  shareBaseUrl?: string;
}

export function generatePythonSidecar(options: PythonSidecarOptions = {}): string {
