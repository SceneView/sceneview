...
import { generateEvChargingStationViewer, CHARGING_CONNECTORS, STATION_LAYOUTS, } from "./ev-charging-station-viewer.js";
...
export async function dispatchTool(toolName, rawArgs, _ctx = {}) {
    switch (toolName) {
        ...
        case "get_ev_charging_station_viewer": {
            const args = rawArgs ?? {};
            const connector = args.connector ?? "ccs";
        ...
        case "get_car_paint_shader": {
            const args = rawArgs ?? {};
            const finish = args.finish ?? "metallic";
            ...
            const template = generateCarPaintShader({
                baseColorHex: args.baseColorHex,
