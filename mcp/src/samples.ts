...
export interface Sample {
  ...
  language?: "kotlin" | "swift" | "kotlin-js";
}
...
export const SAMPLES: Record<SampleId, Sample> = {
  "model-viewer": {
    ...
    prompt:
      "Create an Android Compose screen that loads a GLB model and displays it with HDR lighting, orbit camera, and animation playback. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun ModelViewerScreen() {
  ...
  "ar-model-viewer": {
    ...
    prompt:
      "Create an AR screen that detects surfaces and lets the user tap to place a GLB model. Support pinch-to-scale and drag-to-rotate. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
    code: `@Composable
fun ARModelViewerScreen() {
  ...
  "ar-augmented-image": {
    ...
    dependency: "io.github.sceneview:arsceneview:4.0.0",
    prompt:
      "Create an AR screen that detects a printed reference image and places a 3D model above it. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
    code: `@Composable
fun AugmentedImageScreen() {
  ...
  "ar-cloud-anchor": {
    ...
    dependency: "io.github.sceneview:arsceneview:4.0.0",
    prompt:
      "Create an AR screen that can host a cloud anchor (saving its ID) and resolve it later on another device. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
...
fun CloudAnchorScreen() {
  ...
  "ar-point-cloud": {
    ...
    dependency: "io.github.sceneview:arsceneview:4.0.0",
    prompt:
      "Create an AR screen that visualizes ARCore feature points as small 3D spheres, filtered by confidence. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
    code: `@Composable
fun PointCloudScreen() {
  ...
  "ar-face-mesh": {
    ...
    dependency: "io.github.sceneview:arsceneview:4.0.0",
    prompt:
      "Create an AR screen that uses the front camera to detect faces and overlay a 3D mesh on them. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
    code: `@Composable
fun ARFaceMeshScreen() {
  ...
  "gltf-camera": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene that loads a GLB file containing embedded camera definitions, then uses those cameras for cinematic viewpoints. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun GltfCameraScreen() {
  ...
  "camera-manipulator": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a fully configurable orbit camera — drag to rotate, two-finger pan, pinch to zoom. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun CameraManipulatorScreen() {
  ...
  "camera-animation": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a camera that automatically orbits around a model in a smooth circle. Include a play/pause button. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun CameraAnimationScreen() {
  ...
  "autopilot-demo": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create an autopilot-style visualization with a 3D car on a road and a HUD overlay showing speed, distance, and status. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun AutopilotScreen() {
    val engine = rememberEngine()
    val modelLoader = rememberModelLoader(engine)
  ...
  "physics-demo": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with spheres that fall under gravity and bounce on a floor using per-frame animation. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun PhysicsDemoScreen() {
  ...
  "dynamic-sky": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a time-of-day sun that moves from sunrise through noon to sunset, with animated light color and intensity. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun DynamicSkyScreen() {
  ...
  "line-path": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene that draws animated parametric curves (sine wave, Lissajous) using PathNode with amplitude and frequency sliders. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun LinePathScreen() {
    val engine = rememberEngine()
    val materialLoader = rememberMaterialLoader(engine)
  ...
  "text-labels": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with floating text labels above colored spheres representing planets. Use TextNode for the labels. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun TextLabelsScreen() {
  ...
  "reflection-probe": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a metallic sphere and a ReflectionProbeNode that overrides the IBL. Add a material picker to switch between Chrome, Gold, Copper, and Rough. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun ReflectionProbeScreen() {
  ...
  "post-processing": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with interactive post-processing controls for bloom, vignette, tone mapping, FXAA, and SSAO. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun PostProcessingScreen() {
  ...
  "video-texture": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a video playing on a floating 3D plane. Include play/pause controls and chroma-key support. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun VideoTextureScreen() {
  ...
  "multi-model-scene": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene that loads multiple GLB models (a car, a building, and trees) and positions them to form a street scene. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun MultiModelScreen() {
  ...
  "gesture-interaction": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a model that responds to tap (select), double-tap (scale up), long-press (show info), and supports pinch-to-scale and drag-to-move. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun GestureInteractionScreen() {
  ...
  "environment-lighting": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with full HDR environment lighting (IBL + skybox), a directional sun light, a red point light, and a blue spot light. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun EnvironmentLightingScreen() {
  ...
  "procedural-geometry": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene showing procedural geometry shapes (cube, sphere, cylinder, plane) with different PBR materials. No model files needed. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun ProceduralGeometryScreen() {
  ...
  "compose-ui-3d": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with interactive Compose UI elements (Card with text and a button) floating in 3D space using ViewNode. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun ComposeUI3DScreen() {
  ...
  "node-hierarchy": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D solar system where planets orbit a sun using parent-child node hierarchies. Each planet group rotates independently. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
...
struct VideoPlayerScreen: View {
  ...
  "image-node": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with images displayed on floating planes using ImageNode. Show examples from file, resource, and Bitmap. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun ImageNodeScreen() {
    val engine = rememberEngine()
    val environmentLoader = rememberEnvironmentLoader(engine)
  ...
  "billboard-sprite": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with billboard sprites that always face the camera, useful for markers and info overlays. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun BillboardSpriteScreen() {
  ...
  "animation-state": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with a character model that switches between Idle, Walk, and Run animations based on button clicks. Use animationName for state-driven animation. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun AnimationStateScreen() {
  ...
  "spring-animation": {
    ...
    dependency: "io.github.sceneview:sceneview:4.0.0",
    prompt:
      "Create a 3D scene with geometry nodes that animate position using spring physics via Compose's animateFloatAsState. Tap to toggle positions with springy motion. Use SceneView `io.github.sceneview:sceneview:4.0.0`.",
    code: `@Composable
fun SpringAnimationScreen() {
  ...
  "ar-surface-cursor": {
    ...
    dependency: "io.github.sceneview:arsceneview:4.0.0",
    prompt:
      "Create an AR screen with a surface cursor (reticle) in the center of the screen that follows detected surfaces, using HitResultNode. Tap to place a model at the cursor position. Use SceneView `io.github.sceneview:arsceneview:4.0.0`.",
    code: `@Composable
